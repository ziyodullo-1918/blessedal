...
export const Route = createFileRoute("/tortuvchilar/_admin/live")({
  ...
  const { data: rows, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select(
          "id, quantity, unit_price, total, work_date, worker_id, product_id, created_at, pullers_workers(name, worker_code), pullers_products(name, pullers_categories(name))",
        )
