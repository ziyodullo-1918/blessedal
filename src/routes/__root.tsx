...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tikuv Fabrikasi — Boshqaruv" },
      { name: "twitter:title", content: "Tikuv Fabrikasi — Boshqaruv" },
      { property: "og:description", content: "Tikuv fabrikasi uchun ishchilar, mahsulotlar va oylik hisobotlarni boshqarish tizimi." },
      { name: "twitter:description", content: "Tikuv fabrikasi uchun ishchilar, mahsulotlar va oylik hisobotlarni boshqarish tizimi." },
